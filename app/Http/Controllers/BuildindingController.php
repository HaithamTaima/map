...
{
    public function add_new_building(Request $request){
        ...
        $building->save();
        return redirect('building_details');
    ...
    public function add_new_citizen(Request $request){
        ...
        $citizen->resident_name =  $request->input('citizen_name');
        ...
        $citizen->save();
        return redirect('building_citizens');
    ...
    public function delete_one_building1(Request $request){
        DB::table('citizens')
    ...
    public function edit_one_building1(Request $request){
        DB::table('citizens')
            ->where('id',$request->input('citizen_id'))
            ->update([
